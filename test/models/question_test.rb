...
class QuestionTest < ActiveSupport::TestCase
  def setup
    ...
    @question = quiz.questions.new(title: "What do flamingos eat?", options_attributes: [value: "correct_option", is_correct:true])
  end
  ...
  def test_question_options_should_not_be_blank
    @question.options = []
    assert_not @question.valid?
    assert_equal ["Options can't be blank", "Quiz can't be blank"], @question.errors.full_messages
  end
  ...
  def test_question_should_not_exceed_four_options
